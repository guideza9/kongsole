...
- [ ] R3 — `docs/plans/R3-onboarding-hints.md` (R3.1–R3.6 เสร็จ · ตรวจเกณฑ์ 2026-09-25: rspec 951/0, detect 44 = baseline — รอเจ้าของงานตัดสินข้อค้าง 2 ข้อ; R3.7 ทำหลัง R2)
