...
- [ ] R1 — `docs/plans/R1-multi-project-env.md` (R1.1–R1.11 เสร็จ · R1.12 ตรวจบน compose 2026-09-25: rspec 1033/0, vitest 30/30 · เพิ่ม R1.13–R1.17 ตามคำตัดสินข้อค้าง · clarify/harden 2026-09-25: rspec 1060/0, vitest 30/30, detect 62 · เกณฑ์ปิดงานครบ รอเจ้าของงานยืนยัน + ตัดสินข้อสังเกต 2 ข้อ)
